...
_(v2 features — the worst-case-timing finder and the spending-flexibility lever — shipped July 2026; see the "v2 (shipped)" paragraph above. The v1 placeholder prose in "what this means" was replaced with live prose describing the shipped lever, and its TECH_DEBT entry closed.)_
