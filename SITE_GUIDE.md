...
**Bitcoin as Collateral (§48, shipped 2026-08-18) — slide pending, video briefed.** Lands as a follow-up PR per NEW_PAGE_CHECKLIST §8. Label "Bitcoin as Collateral"; headline *"The pledge you can see."*; sub *"Four thousand years of collateral – and the first pledge anyone can verify."*; CTA *"Read the exploration →"*. Video brief: dark, slow, ember-warm, no text in frame, no faces — three takes to choose between, all on one concept (verification replacing concealment, the thing you were asked to trust becoming the thing you can see): **the seal** (a wax seal pressed onto parchment, the impression glowing from within as the stamp lifts, resolving into a faint geometric lattice), **the boundary stone** (a slow dolly at dusk toward an ancient stone marker whose carved lines begin to glow warm from inside, pulsing like a heartbeat), **the vault that became glass** (a massive vault door that, instead of opening, turns translucent — revealing not gold bars but a single steady point of warm light). Fallback camp if none lands after a round: the ledger-line aesthetic, glowing thin amber lines drawing themselves across dark paper. Featured status not yet decided.
...
| 17 | The Bitcoin Horizon | — | What looks like turbulence over the course of a day is *trajectory over the course of a decade.* | Small ship at golden hour, crossing toward the horizon; near-shore chop, steady distant line; persistence-through-turbulence |
| 18 | Is Bitcoin a Bubble? | — | A thing isn't a bubble simply because *it has been called one.* | ~10 bubbles burst; one amber object remains impervious |
| 19 | The Half-Life | — | How long until your money *loses half its value?* | Candle burning down asymptotically |
| 20 | The Melting Ice Cube | — | Holding cash is not safety. It's an *active decision with an ongoing cost.* | Ice cube melts to fragment on weathered wood |
| 21 | The Bitcoin Synthesis | — | Six components. *One irreducible synthesis.* | Six antique keys assemble into clockwork mechanism |
| 22 | What Bitcoin Is | — | Most people consider just a few dimensions. Bitcoin is *all of them, simultaneously* | Raw mineral crystal, traveling amber light |
| 23 | The Bitcoin Migration | 0 | From what can't be fixed, *to what can't be broken.* | Heavy wooden door opens ~2/3, amber light. **Demoted from Featured 2026-08-07** (feat 1→0) to promote The Bitcoin Hurdle Rate — holds Featured at 13 and shifts balance to The Numbers; stays in the Arguments tab. |
| 24 | The Trilemma | — | Some problems are *navigated, not solved.* | Three geometric counterweights in coupled sway |
| 25 | The Money Trees | — | Two systems. *Different roots. One outcome.* | Two trees; left withers, right unchanged |
| 26 | The Bitcoin Retirement | **1** | A stack that lasts a lifetime — *or runs out before you do.* | Solitary mature tree in golden-hour meadow; sun moves from behind canopy to streaming rays through it; latent-state opening, persistence across the arc |
| 27 | Disciplined Rebalancing | — | A model you believe in is *a protocol you can run.* | Wheat field at golden hour, ears swaying in coupled bounded oscillation; fixed camera, stable disequilibrium |
| 28 | The Fixed Pie | 0 | Your share remains undiluted — *for eternity.* | Unmarked gold coin; surrounding coins dissolve |
| 29 | Bitcoin vs. The Stock Market | **1** | Three growth curves. *One decisive horizon.* | Three trees in a meadow at golden hour; the middle tree grows dramatically taller and fuller-canopied over 10 seconds while the flanking trees mature modestly; latent-state opening, divergent outcomes from identical conditions |
| 30 | The Bitcoin Heatmap | — | The pattern reveals itself *only when you zoom out.* | (concept retrospectively documented — see live markup `src/index.njk` for the as-shipped video) |
| 31 | Borrowing Against Your Stack | — | Every coin sold today is a coin that *compounds for someone else.* | Solitary ancient standing stone — weathered, lichen-marked, ~six feet tall — in a golden-hour meadow; tall grasses bend in gentle wind, long shadow extends from the stone across the foreground; the stone itself does not move; quiet persistence as the visual argument |
| 32 | Bitcoin-Backed Mortgages | — | The home opens. *The stack stays.* | (concept retrospectively documented — see live markup `src/index.njk` for the as-shipped video) |
| 33 | Living on Bitcoin | — | Save in bitcoin. Spend in fiat. *The float holds.* | (concept retrospectively documented — see live markup `src/index.njk` for the as-shipped video) |
| 34 | Bitcoin Defined | — | Define it. *Then debate it.* | Bed of glowing embers in deep darkness — same composition as Card 7 (Bounded by Energy) on the page. Camera fixed throughout. Four-layer subtle motion: heat shimmer above the bed, asymmetric ember pulse (no two embers in sync), a small natural wood-fire flame at center-left with irregular asymmetric tongues whose base merges with the surrounding embers, wisps of pale smoke rising and dissipating. Seamlessly looping 10-second silent video. |
...
### Iteration record — slide 38, What Daily Conviction Bought (August 2026)
...
### Iteration record — slide 36, STRC Below Par (July 2026)
