...
- **Bitcoin vs. Real Estate (row 6) — REPLACE, confirmed and measured.** Opens at 41.9% mean luminance and falls to 14.8%; a window light comes on mid-clip and is out again by the close, so it ends darker than it began. Fails gate items 2 and 3. Replacement brief approved, generation in progress.
- **Bitcoin and The Power Law (row 10) — pass → REPLACE.** The metaphor survives review — village lights multiplying is the right picture of a network compounding — but the execution never exceeds 18.8% mean luminance and its arc falls. Fails gate items 1 and 2. Replacement brief approved, generation in progress.

**Both replacements are footage-gated, not schedule-gated.** The wiring PR for rows 6 and 10 happens only once candidate footage clears the acceptance gate chat-side; neither row changes in markup before then.
...
| 6 | Bitcoin vs. Real Estate | — | Housing became the default store of value *by elimination, not merit* | Golden hour → twilight → dark silhouette **REPLACE — register audit 2026-08-26.** Opens at 41.9% mean luminance and falls to 14.8%; a window light comes on mid-clip and is out again by the close. Replacement brief approved, generation in progress. **The wiring PR happens only after the candidate footage clears the acceptance gate chat-side.** |
...
| 10 | Bitcoin and The Power Law | 0 | For every 13% increase in Bitcoin's age, *the trend price doubles.* | Town at dusk, lawful illumination pattern **REPLACE — register audit 2026-08-26.** The metaphor is kept — village lights multiplying is the right picture of a network compounding — but the execution is too dark: it never exceeds 18.8% mean luminance and its arc falls. Replacement brief approved, generation in progress. **The wiring PR happens only after the candidate footage clears the acceptance gate chat-side.** |
