...
- **Money-market / savings presets** — the two short-rate-sensitive presets (~4.3% / ~4%) are labelled approximate starting points the user overrides; deliberately **not** added to MONTHLY_REFRESH to hold the refresh tail at zero (design §5.4 "prefer stable or clearly-labelled presets"). Flagged in the PR for JM.
