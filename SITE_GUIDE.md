...
- ~~**Carousel slide** pending~~ — **shipped June 2026** (firelit two-glass pour, bold vs. thin; slide #25, `data-feat="1"`; deployment trilogy P1 — see §13 inventory + iteration record).
...
### Open items
- ~~**Carousel slide** pending~~ — **shipped June 2026** (aerial golden river valley, a tributary joining the main river; slide #26, `data-feat="1"`; deployment trilogy P2 — see §13 inventory + iteration record).
...
### Open items
- ~~**Carousel slide** pending~~ — **shipped June 2026** (sun emerging from behind a cloud bank over a calm sea; slide #27, `data-feat="1"`; deployment trilogy P3 — see §13 inventory + iteration record).
