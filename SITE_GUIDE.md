...
- ~~**Carousel slide** pending~~ — **shipped July 2026** (amber ink bloom in dark water, v2 after a quantified-size-budget rewrite; slide #28, `data-feat="0"`; see §13 inventory + iteration record).
