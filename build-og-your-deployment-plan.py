#!/usr/bin/env python3
"""
Brand-forward OG card generator — Your Deployment Plan
...
Run from repo root (where og-synthesis.jpg exists):
    python build-og-your-deployment-plan.py
Outputs: og-your-deployment-plan.jpg (1280x720, JPEG q80, ~75-95KB).
"""
...
img.save("og-your-deployment-plan.jpg", "JPEG", quality=80, optimize=True)
print("saved og-your-deployment-plan.jpg", os.path.getsize("og-your-deployment-plan.jpg") // 1024, "KB")
