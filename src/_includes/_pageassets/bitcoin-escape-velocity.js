...
(function () {
  ...
  // nominal, so switching basis is a re-render, not a recompute.
  // Rule (2026-09-20, same as the flagship, commit 30199a0; reverses the earlier
  // "BTC price is never deflated" display ruling): in the Verify-the-math table
