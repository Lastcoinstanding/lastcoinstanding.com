...
var bdWords = [
    {
        ...
        label: 'Network',
        eyebrow: 'Word 1 of 8',
        definition: 'A network is not a thing; it is a relationship between things. Bitcoin is the persistent agreement among tens of thousands of independent nodes scattered across the world, each validating the same ledger.',
        elaboration: '<p>Calling Bitcoin an asset misses what it actually is. The asset only exists because the network does &mdash; the bitcoin you hold is meaningful only as a recognized entry on a ledger that thousands of unrelated parties happen to agree upon.</p><p>This is the foundational reframe. Before any property of Bitcoin can be discussed, what kind of thing it is has to be settled. A network. Living. Distributed. The asset is a consequence, not the substance.</p>',
    ...
    },
    {
        ...
        label: 'Open',
        eyebrow: 'Word 2 of 8',
        definition: 'The source code is readable, the protocol\u2019s rules are visible, and the full transaction history is auditable &mdash; by anyone, indefinitely. There are no proprietary layers, no closed components, no secrets.',
        elaboration: '<p>Closed systems require trust in their operators. Open systems require only that you can read. The radical move is not just publishing the code &mdash; it is making the entire apparatus inspectable, forever, by anyone with curiosity and time.</p><p>This is how a system earns belief without asking for it. The reader does not have to take anyone\u2019s word. Every claim Bitcoin makes about itself is checkable from first principles.</p>',
    ...
    },
    {
        ...
        eyebrow: 'Word 3 of 8',
        definition: 'Open lets you read the system. Permissionless lets you join it. No application, no approval, no identity check &mdash; anyone, anywhere, can run a node, mine, hold, send, or build.',
        elaboration: '<p>The protocol has no gatekeeper because it has no central party that could be one. This is a different category of access than even the open internet, where platforms, payment rails, and ISPs still mediate participation.</p><p>Bitcoin\u2019s permissionless quality is closer to gravity than to a service. It does not ask who you are before it works. For most of human history, monetary access has been conditioned on someone\u2019s permission. This is the first money for which that is no longer true.</p>',
    ...
    },
    {
        ...
        label: 'Protocol',
        eyebrow: 'Word 6 of 8',
        definition: 'Bitcoin is a protocol, not a product, not a company, not a technology in the conventional sense. A protocol is a set of agreed-upon rules &mdash; TCP/IP is a protocol; HTTP is a protocol; SMTP is a protocol. None has a CEO.',
        elaboration: '<p>This distinction is load-bearing. Companies can be acquired, regulated, dissolved. Protocols, once widely adopted, become a kind of public infrastructure &mdash; older than the institutions built on top of them, more durable than any of their participants.</p><p>Bitcoin is best understood by analogy to the early internet. TCP/IP did not have a marketing department. It just described how parties could communicate, and anyone who followed the rules became part of the network.</p>',
    ...
    },
    {
        ...
        elaboration: '<p>This binding to thermodynamics is what makes bitcoin\u2019s issuance impossible to fake and its supply curve impossible to game. Fiat money has no such binding; it is created with a keystroke.</p><p>Bitcoin is the first money in the digital era whose existence is physically expensive. The cost is not a side effect of the system &mdash; it is the proof that the system is real. Energy spent is the only signature the protocol accepts.</p>',
