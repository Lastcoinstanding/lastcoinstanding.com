...
- [x] **What Daily Conviction Bought — daily-conviction DCA tool (The Numbers).** → shipped as `what-daily-conviction-bought` (`/what-daily-conviction-bought.html`) in `1601a05`, 2026-08-05. Full record in **SITE_GUIDE §43**.
  ...
  - **v1.1 SHIPPED 2026-08-06** (three JM additions): (1) "If the habit continued" — a three-band forward scenario block (10 more years of the daily buy, floor/trend/upper, with a `?stack=`+`?dca=` handoff into The Bitcoin Retirement); (2) a Peak-value stat ("visible only in the rearview mirror"); (3) a rich chart hover/tap tooltip (date · contributions · value · BTC held · multiple). The forward block narrowly amends R1 (banded scenarios allowed; sustainability stays the retirement cluster's) — recorded in SITE_GUIDE §43. Parity untouched.
