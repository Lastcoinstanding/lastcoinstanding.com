# The Bitcoin Exit — published essay (canonical record)
...
**Live:** https://lastcoinstanding.substack.com/p/the-bitcoin-exit — published 2026-08-03.
...
- $30/day from 2017-01-01: crossed $1,000,000 on **2024-11-19** — day 2,880, **$86,400** in, 11.1348 BTC at $90,873 spot.
- Matches the widely reported story within rounding ($86,370 / 7y10m12d — Benzinga Nov 2024; crypto.news Jun 2025 citing X post by @lynk0x).
- As of 2026-07-31 sample: 11.3447 BTC, $104,970 in, stack **~$715K** (post-peak drawdown shown, not cropped). Deepest stack drawdown −73.3% (trough 2022-11-19).
- Lepard attribution confirmed: "The Big Print Is Coming: Dollar = Titanic, Bitcoin = Lifeboat" (THE Bitcoin Podcast / YouTube).

**Editorial decisions worth reusing:**
- Epigraph mirrors close: "Conviction is common. Walking through the door is rare." / "...one deliberate, boring, repeated step at a time."
- **Word system (JM's, keep consistent in future pieces):** *recognition* = the intellectual step (fiat/bitcoin are recognized, not believed); *belief* = the visceral leap the linear brain fights; *action* = the third step. Bottleneck line uses "recognizing"; brain section uses "refuses to believe."
- Retirement section is strictly first-person memoir: JM's self-directed IRA path as story; brokerage window compressed to one parenthetical + "I didn't use it"; no providers, no tickers; accountant + plan administrator as the verification standard; honest caveat ("if it feels like risk and anxiety, it's not for you - and no one should talk you into it"); disclosure block at end. The generic mechanics survey remains counsel-gated in the backlog (site version, if any).
- Story cites OUR recomputed figures as primary, coverage as corroboration; duration/totals stated (start-year ambiguity in coverage: 2016 vs 2017), "price drawdowns" (not stack) for the 70%+ claim.
- Honest coda kept: crossed $1M, now ~$715K — "The ride down is part of the ride - and $30 a day keeps buying."
- Register: hyphens, not em-dashes (JM preference, all drafts).
...
Here's what that looks like in practice. There's an investor who bought $30 of bitcoin every single day - coffee money. On November 19, 2024 - 2,880 days and $86,400 in - the stack crossed one million dollars. The story was [widely reported](https://www.benzinga.com/markets/cryptocurrency/24/11/42170334/bitcoin-investor-turns-daily-30-purchases-into-1-million-portfolio-in-7-years-10-months-an) when it happened; I recomputed it from bitcoin's actual price history - the same data behind [the Power Law exploration](https://lastcoinstanding.com/the-power-law.html) - and the arithmetic checks almost to the dollar. And an honest coda the chart below doesn't hide: in the drawdown since, that same stack is worth about $715,000. The ride down is part of the ride - and $30 a day keeps buying.

*[chart: "The inputs are linear. The outcome is not." - contributions vs. stack value]*
